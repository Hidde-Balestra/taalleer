...
/// Ongegradeerde oefening: speelt het Spaanse woord af (geen tekst) en de
/// gebruiker typt de vertaling. Net als [PracticeScreen] telt dit niet mee
/// voor de wekelijkse-toets-lock, geen `QuizResult`.
...
class _ListeningPracticeScreenState extends State<ListeningPracticeScreen> {
  late final List<Question> _questions = buildListeningPractice(
    widget.words,
    widget.sourceLang,
  );
  ...
  void _play() {
    speechService.speak(_questions[_idx].word.target, widget.course.ttsLocale);
  }
...
class _ListeningFeedback extends StatelessWidget {
  final Strings t;
  final bool correct;
  final String correctAnswer;
  final String target;

  const _ListeningFeedback({
    required this.t,
